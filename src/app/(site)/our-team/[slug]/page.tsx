...
import { getTeam, getTeamMember } from "@/content/team";
...
// No generateStaticParams: this segment renders dynamically (see app/(site)/layout.tsx),
// and generateStaticParams would otherwise run at `docker build` time with no Postgres
// reachable yet.
