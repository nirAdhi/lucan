 ...
 * 404 page (PRD s24).
 *
 * A missing page is a lost patient, so this one routes people onward rather than
 * apologising. Every 404 that shows up in Search Console should end up as a rule in
 * content/redirects.ts - this page is the safety net, not the plan.
 */
