...
/** All treatment pages are statically generated at build time (PRD s54). */
...
export default async function TreatmentPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const prices = getPrices(treatment.priceSlugs);
  const clinicians = getTeamForTreatment(treatment.slug);
